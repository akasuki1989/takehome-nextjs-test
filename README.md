...
- If you run the app with `npm run dev`, it shows ballot data from the provided API.

- In each category, you can nominate one movie.

- After selecting all nominees, the `Submit` button becomes available.

- Once you submit, the modal with nominees information appears.

- By clicking the `X` button on the top right corner, you can hide the modal.

> **Styling is implemented as the guidlines.**
